...
RESULT_TXT = PROJECT_DIR / "evaluation_base_test1_normalized_result.txt"
RESULT_CSV = PROJECT_DIR / "evaluation_base_test1_normalized_result.csv"
...
def main():
    ...
    summary = (
        "KẾT QUẢ MODEL GỐC TRÊN TEST_1 - RAW VS NORMALIZED\n"
